...
int main()
{
   ...
   /* unsigned int rboDepth;
    ...
    shaderBloomFinal.setInt("depthMap", 2);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        shaderBloomFinal.setFloat("focus_range", focus_range);
        shaderBloomFinal.setFloat("focus_distance", focus_distance);
